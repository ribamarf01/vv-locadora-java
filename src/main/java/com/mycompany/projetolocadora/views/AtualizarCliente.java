...
public class AtualizarCliente extends javax.swing.JFrame {
    ...
    public AtualizarCliente(long linha) {
        initComponents();
        this.linha = linha;
        
        p = MainView.bdPessoa.listarClientes().get((int)linha);
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Alterar Cliente: ");
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        ...
        if(MainView.bdPessoa.atualizarCliente(p)) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AtualizarCliente(0).setVisible(true);
            }
        });
    }
