...
public class AtualizarFilme extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        BottomLayout.setVerticalGroup(
            BottomLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, BottomLayout.createSequentialGroup()
                .addComponent(btnAtualizar, javax.swing.GroupLayout.DEFAULT_SIZE, 39, Short.MAX_VALUE)
                .addContainerGap())
            .addGroup(BottomLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, BottomLayout.createSequentialGroup()
    ...
    private void btnAtualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAtualizarActionPerformed
        ...
        if(MainView.bdFilme.atualizarFilme(f)) {
            MainView.atualizaTabelaFilmes();
            this.dispose();
        } else JOptionPane.showMessageDialog(this, "Houve um erro ao atualizar, verifique as informações e tente novamente!");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AtualizarFilme(0).setVisible(true);
            }
        });
    }
